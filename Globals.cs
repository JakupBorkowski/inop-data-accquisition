...
namespace USB_205_DataAccquisition
{
    static class Globals
    {
        ...
        public static string sql = "datasource=usb-205-db.cqbuehkqw2v3.us-east-1.rds.amazonaws.com;port=3306;username=admin;password=Maciej1!!;database=usb205db;Convert Zero Datetime=True";
