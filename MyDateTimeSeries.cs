...
{
    internal class MyDateTimeSeries : Series
    { 
        ...
        List<double> values;
        List<long> dates;
        //the dates that correspond to the start and end of the x-axis
        private DateTime minDate;
        private DateTime maxDate;

        //the numerical values of the axis that should be mapped
        //to thet minDate and maxDate, Could be public properties
